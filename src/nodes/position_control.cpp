...
#include <cstdlib>
#include <stdint.h>
#include <dynamixel_motors_driver/position_control.h>
#include <dynamixel_motors_driver/JointSpeed.h>
#include <dynamixel_motors_driver/TorqueEnable.h>
#include <dynamixel_motors_driver/GoalPosition.h>
...
bool PositionControl::jointSpeedCallback(dynamixel_motors_driver::JointSpeed::Request &req,
                                         dynamixel_motors_driver::JointSpeed::Response &res)
{
  int32_t speed = 0;
...
bool PositionControl::jointTorqueEnableCallback(dynamixel_motors_driver::TorqueEnable::Request &req,
                                                dynamixel_motors_driver::TorqueEnable::Response &res)
{
  bool torque_enable = false;
...
// Topics
void PositionControl::goalJointPositionCallback(const dynamixel_motors_driver::GoalPosition::ConstPtr& msg)
{
  for (int index = 0; index < dxl_cnt_; index++)
